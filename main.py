...
analyzer1 = FirstAnalyzer(SamplerType.ACID_SAMPLING, PerturberType.BINARY_PERTURBING, sample_size = sampleSize, fail_probability = 0.001)
analyzer1.print_analyze()

analyzer2 = SecondAnalyzer(SamplerType.ACID_SAMPLING, PerturberType.QUALITY_SCORE_PERTURBING, sample_size = sampleSize, fail_probability = 0.001, bounds = [25, 30])
analyzer2.print_analyze()

analyzer3 = ThirdAnalyzer(SamplerType.ACID_SAMPLING, PerturberType.DISTRIBUTED_QUALITY_SCORE, sample_size = sampleSize, goal = 0.001)
...
plt.show()
# make the zoomed in plot, doesn't work 
# start = 15
# prob_standard_dev1 = np.zeros((2, 2, end - start))
# prob_standard_dev2 = np.zeros((2, 2, end - start))
# prob_standard_dev3 = np.zeros((2, 2, end - start))
