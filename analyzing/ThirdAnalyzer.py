...
class ThirdAnalyzer(Analyzer):
    ...
    def print_analyze(self):
        ...
        print("Minimal Q score to ensure error probability in all calls with this score or higher is less than the goal: ", analysis[5])
    ...
    def analyze(self):
        ...
        deviations = [0] * self.SAMPLE_SIZE
        repairable_deviations = [0] * self.SAMPLE_SIZE
        ...
        for j in range(self.SAMPLE_SIZE):
            ...
            repairable_deviations[j] = (total_repairable - old_total_repairable) / (total - old_total) * 100
        ...
        return [error_perc, rep_perc, rep_perc2, standard_deviation, standard_deviation_repairable, achieve_goal, geq_30_wrong_perc]
